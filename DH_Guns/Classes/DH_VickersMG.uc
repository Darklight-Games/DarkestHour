...
//==============================================================================
// Air-cooled, belt-fed machine gun variant for the Vickers mount.
//==============================================================================

class DH_VickersMG extends DHMountedMG;
...
defaultproperties
{
    ...
    // Ammo
    ProjectileClass=Class'DH_VickersBullet'
    FireInterval=0.12    // 500rpm
    TracerProjectileClass=Class'DH_VickersTracerBullet'
    TracerFrequency=7
