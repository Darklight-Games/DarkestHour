...
class DH_RKKA_GreenTelogreikaRadioOperatorEarly extends DHSOVRadioOperatorRoles;

defaultproperties
{
    RolePawns(0)=(PawnClass=Class'DH_SovietGreenTeloStrapsEarlyPawn',Weight=1.0)
