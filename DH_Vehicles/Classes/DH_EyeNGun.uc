...
class DH_EyeNGun extends DHVehicleAutoCannon;
...
defaultproperties
{
    ...
    PrimaryProjectileClass=Class'DH_KnifePurple'
    ...
    CannonFireSound(0)=Sound'DH_UFO_snd.UFO.UfoShotB'
    CannonFireSound(1)=Sound'DH_UFO_snd.UFO.UfoShotB'
    CannonFireSound(2)=Sound'DH_UFO_snd.UFO.UfoShotB'
    ...
    // Coaxial MG ammo
    AltFireProjectileClass=Class'DH_KunaiPurple'
