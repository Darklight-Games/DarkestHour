...
defaultproperties
{
    ...
    VehicleHudTurret=TexRotator'DH_InterfaceArt_tex.panzer4h_turret_rot'
    VehicleHudTurretLook=TexRotator'DH_InterfaceArt_tex.panzer4h_turret_look'
    ...
    SpawnOverlay(0)=Material'DH_InterfaceArt_tex.panzer4_g'
