...
class DH_EyeWGun extends DHVehicleAutoCannon;
...
defaultproperties
{
    ...
    PrimaryProjectileClass=Class'DH_KnifeGrey'
    ...
    CannonFireSound(0)=Sound'DH_UFO_snd.UFO.EyeSmallShotA'
    CannonFireSound(1)=Sound'DH_UFO_snd.UFO.EyeSmallShotB'
    CannonFireSound(2)=Sound'DH_UFO_snd.UFO.se_tan01'
