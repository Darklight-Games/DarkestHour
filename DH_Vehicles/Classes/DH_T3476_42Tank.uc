...
defaultproperties
{
    ...
    PassengerWeapons(0)=(WeaponPawnClass=Class'DH_T3476_42CannonPawn',WeaponBone="Turret_Placement")
    ...
    DriverPositions(0)=(ViewFOV=85,PositionMesh=SkeletalMesh'DH_T34_2_anm.T34m42_hull_int',TransitionUpAnim="driver_hatch_open",DriverTransitionAnim="Vt3485_driver_close",ViewPitchUpLimit=0,ViewPitchDownLimit=65535,ViewPositiveYawLimit=0,ViewNegativeYawLimit=0,bDrawOverlays=true)
    DriverPositions(1)=(ViewFOV=85,PositionMesh=SkeletalMesh'DH_T34_2_anm.T34m42_hull_int',TransitionDownAnim="driver_hatch_close",DriverTransitionAnim="Vt3485_driver_open",ViewPitchUpLimit=5500,ViewPitchDownLimit=63500,ViewPositiveYawLimit=11000,ViewNegativeYawLimit=-12500,bExposed=true)
    ...
    SpawnOverlay(0)=Material'DH_InterfaceArt_tex.T34m42'
