...
// Props to Moz
//-----------------------------------------------------------
class DH_DieGlocke extends ROChopperCraft;
...
defaultproperties
{
     DriverWeapons(0)=(WeaponClass=Class'DH_Vehicles.DH_DieGlockeGun',WeaponBone="Turret_placement3")
     ...
     IdleSound=Sound'DH_UFO_snd.UFO.DieGlockeEngine'
     StartUpSound=Sound'DH_UFO_snd.DieGlockeStart'
     ShutDownSound=Sound'DH_UFO_snd.UFO.DieGlockeEnd'
     ...
     End Object
     Wheels(0)=SVehicleWheel'DH_Vehicles.DH_DieGlocke.LFWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=RFWheel1
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(1)=SVehicleWheel'DH_Vehicles.DH_DieGlocke.RFWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=LRWheel1
         ...
         SupportBoneAxis=AXIS_X
     End Object
     Wheels(2)=SVehicleWheel'DH_Vehicles.DH_DieGlocke.LRWheel1'
     ...
     End Object
     KParams=KarmaParamsRBFull'DH_Vehicles.DH_DieGlocke.KParams1100'
