...
defaultproperties
{
    ...
    FaceSkins(0)=Texture'DHUSCharactersTex.US_AB_Face1'
    FaceSkins(1)=Texture'DHUSCharactersTex.US_AB_Face2'
    FaceSkins(2)=Texture'DHUSCharactersTex.US_AB_Face3'
    FaceSkins(3)=Texture'DHUSCharactersTex.US_AB_Face4'
    FaceSkins(4)=Texture'DHUSCharactersTex.US_AB_Face5'
