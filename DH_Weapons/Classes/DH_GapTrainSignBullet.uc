...
class DH_GapTrainSignBullet extends DHCannonShellAPDS;
...
defaultproperties
{
    ...
    StaticMesh=StaticMesh'DH_UFO_stc.UFO.trianglesign_bullet'
    DeflectedMesh=StaticMesh'DH_UFO_stc.UFO.trianglesign_bullet'
    SpeedFudgeScale=1.0
    TracerHue=0
    CoronaClass=none
    bHasTracer=false
